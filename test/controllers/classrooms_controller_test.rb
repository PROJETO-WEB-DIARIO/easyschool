...
class ClassroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classroom" do
    assert_difference("Classroom.count") do
      post classrooms_url, params: { classroom: { name: @classroom.name, series: @classroom.series, year: @classroom.year } }
    end
  ...
  test "should update classroom" do
    patch classroom_url(@classroom), params: { classroom: { name: @classroom.name, series: @classroom.series, year: @classroom.year } }
