class StudentsController < ApplicationController
  ...
  private
    ...
    def student_params
      params.require(:student).permit(:name, :email, :date_of_birth, :cpf, :rg, :nationality, :birth_city, :birth_state, :gender, :skin_color_or_race, :phone, :address, :city, :state, :father_name, :father_cpf, :father_rg, :father_occupation, :zip_code, :mother_name, :mother_cpf, :mother_rg, :mother_occupation, :has_family_allowance, :has_disability, :requires_religious_education_exemption,  classroom_ids: [])
    end
end
